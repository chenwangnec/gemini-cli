...
export const ALL_ITEMS = [
  ...
  },
  {
    id: 'git-branch',
    header: '分支',
    description: '显示当前 Git 分支名称（不可用时不显示）',
  },
  {
    id: 'sandbox',
    header: '沙箱',
    description: '沙箱类型及信任状态指示器',
  },
  {
    id: 'model-name',
    header: '模型',
    description: '当前使用的模型标识符',
  },
  {
    id: 'context-used',
    header: '上下文',
  ...
  },
  {
    id: 'quota',
    header: '配额',
    description: '今日已使用的配额百分比（不可用时不显示）',
  },
  {
    id: 'memory-usage',
    header: '内存',
    description: '应用程序占用的内存',
  },
  {
    id: 'session-id',
    header: '会话ID',
  ...
  },
  {
    id: 'auth',
    header: '认证',
    description: '当前身份认证信息',
  },
  {
    id: 'code-changes',
    header: '变更',
    description: '本会话中添加/删除的代码行数',
  },
  {
    id: 'token-count',
    header: 'Tokens',
    description: '本会话中消耗的总 Tokens 数',
  },
] as const;
